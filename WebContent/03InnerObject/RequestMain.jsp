...
<body>
	...
	<!--  
	Get 전송방식에는 3가지 전송방식이 있다.
	1. <a href="" 를 사용하는 방법
	2. JS의 location.href=""를 사용한느 방법
	3. <form method="get" 을 사용하는방법	
	-->
	<h3>Get 방식 전송</h3>
	<a href="RequestInfo.jsp?paramNum=123&paramEng=Hollow&paramHan=안녕">
	a태그를 이용한 Get방식전송
	</a>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		<br />
		자기소개 : 
			<textarea name="self_intro" cols="30" rows="10">나는 부유한집에서 태어나서 대충살아씀</textarea>
		<br />
			<input type="submit" value="POST방식" />
		</form>
		...
		<div style="font-size:14px; color : blue">
			<ol>
				<li>RequestHeader자체 실행: referer항목 보이지 않음</li>
